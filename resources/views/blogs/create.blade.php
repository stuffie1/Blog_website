                ...
                <div class=" flex items-center justify-center p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="my-4 mx-auto" style="width: 50%">
                        <h1 class="text-gray-600 text-xl font-bold mx-auto text-center " style="margin-bottom: 30px ">
                            Create New Blog</h1>
                        <form class="min-w-xl mx-auto" action="{{ route('blogs.store') }}" enctype="multipart/form-data"
                            method="post">
                            @csrf
                            <div style="margin-bottom: 30px">
                                ...
                                <input type="text" id="title" name="title"
                                    ...
                                    placeholder="write a title" value="{{ old('title') }}" />
                                @error('title')
                            ...
                            <div style="margin-bottom: 30px">
                                <label for="categories"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" style="margin-bottom: 10px">Categorie</label>
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="text-white bg-indigo-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto mx-auto  px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create
                                    Blog</button>
                            </div>
                        </form>
